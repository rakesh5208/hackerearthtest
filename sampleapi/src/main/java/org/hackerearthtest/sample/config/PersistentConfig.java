package org.hackerearthtest.sample.config;
...
@EntityScan(basePackages = { "org.learningwithrakesh.codaglobalapi" })
public class PersistentConfig {
	...
	public LocalSessionFactoryBean setupSessionFactory() {
		...
		sessionFactory.setPackagesToScan("org.learningwithrakesh.betterplaceapi.entity");
